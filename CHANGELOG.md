...
- Unified listing and cancellation, added configurable annotation staging and local scan controls, and fixed dry-run validation, transfer, deletion, CRT, and aws-cli parity edge cases.
