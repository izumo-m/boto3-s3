...
- Exception polish: an invalid `case_conflict` or `presign` `method` value now raises `ValidationError`, and errors now carry the running operation's name and location context.
