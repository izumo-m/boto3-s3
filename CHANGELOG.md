...
- Unified listing and cancellation, added configurable annotation staging and local scan controls, and fixed transfer, deletion, CRT, and aws-cli parity edge cases.
