...
- The process-fatal Ctrl-C posture (`S3(wait_on_interrupt=False)`) now abandons an in-flight listing page pull whichever window the interrupt lands in; previously an interrupt outside the pull itself waited the pull out.
