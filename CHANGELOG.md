...
- Unified listing and cancellation, added annotation-aware copy modes and local scan controls, and fixed transfer, deletion, CRT, and aws-cli parity edge cases.
