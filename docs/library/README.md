...
The [README](../../README.md) has a broader tour with more examples, and the
design documents indexed in [`overview.md`](../../design/overview.md) section 4
explain how the pieces are built.
